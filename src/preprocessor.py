...
def clean_text(text):
    ...
    text = re.sub(r"***", " ", text)
    text = re.sub(r"qb", "Q币", text)
    text = re.sub(r"QB", "Q币", text)
    text = re.sub(r"q币", "Q币", text)

    text = re.sub(r"蚂蚁花呗", "花呗", text)
    text = re.sub(r"蚂蚁借呗", "借呗", text)
    text = re.sub(r"花被", "花呗", text)
    text = re.sub(r"借贝", "借呗", text)
    text = re.sub(r"商网贷", "网商贷", text)
