    ...
    def __init__(self, inpath, word_vocab=None, char_vocab=None, label_vocab=None,
        ...
        for batch_index, (batch_start, batch_end) in enumerate(batch_spans):
            ...
            if options.global_padding:
                cur_batch = InstanceBatch(cur_instances, with_char=options.with_char, max_sent_length=options.max_sent_length)
            else:
                cur_batch = InstanceBatch(cur_instances, with_char=options.with_char, max_sent_length=0)
...
class InstanceBatch(object):
    def __init__(self, instances, with_char=False, max_sent_length=0):
